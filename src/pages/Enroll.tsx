...
import { HiOutlineUser, HiOutlineMail, HiOutlinePhone, HiOutlineBookOpen, HiOutlineCheckCircle } from 'react-icons/hi';
import { useNavigate } from 'react-router-dom';

// The random math is calculated ONCE outside the component
...
const COMPANY_WHATSAPP = "917904075373"; // Without +, spaces, or special characters
...
const Enroll: React.FC = () => {
  ...
  const handleCloseEverything = () => {
    ...
    setSubmitError(null);
    navigate('/'); // Navigate to the homepage instead of closing modal
  };

  return (
    <div className="min-h-[85vh] bg-slate-50 flex flex-col items-center justify-center py-16 px-4 relative overflow-hidden font-sans">
      {/* Background Blobs */}
      <div className="absolute top-0 left-0 w-full h-full pointer-events-none -z-10 opacity-50">
        <div className="absolute top-[-10%] left-[-10%] w-[50%] h-[50%] bg-[#008bdc]/10 rounded-full blur-[80px]"></div>
        <div className="absolute bottom-[-10%] right-[-10%] w-[50%] h-[50%] bg-[#f47529]/10 rounded-full blur-[80px]"></div>
      </div>

      {/* --- MAIN CONTENT CONTAINER --- */}
      <div className="relative w-full max-w-[500px] z-10 animate-fade-in">
