              ...
              {[...Array(2)].map((_, setIndex) => (
                <div key={setIndex} className="flex justify-around w-full items-center px-2">
                   {[
                     ...
                     { name: 'HCL', url: 'https://e7.pngegg.com/pngimages/685/961/png-clipart-logo-brand-trademark-product-design-hcl-technologies-design-blue-text.png' },
                     { name: 'Tech Mahindra', url: 'https://s32519.pcdn.co/wp-content/uploads/2025/05/logo.png' },
